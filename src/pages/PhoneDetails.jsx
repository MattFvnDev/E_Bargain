...
const PhoneDetails = () => {
  ...
  const [image, setImage] = useState(phoneDetail[0].img)
  const changeImage = (e) => {
        ...
        <div className="w-full flex-1 max-w-md border border-opacity-50 rounded-md shadow-lg p-6 bg-white">
          ...
          <div className="mt-4 border-t pt-4">
            ...
            <div className="mt-2 flex items-center space-x-3">
              ...
              <p className="font-semibold text-xl">{phoneDetail[0].quantity}</p>
